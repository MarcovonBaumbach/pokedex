...
let pokemons = ['charmander', 'charmeleon', 'growlithe', 'vulpix', 'ponyta', 'cyndaquil', 'bulbasaur', 'ivysaur', 'treecko', 'exeggcute', 'bellsprout', 'squirtle', 'psyduck', 'staryu', 'seel', 'wooper', 'pikachu', 'magnemite', 'voltorb', 'golbat'];
let pokemonTypes = [
    {
        type: 'fire',
